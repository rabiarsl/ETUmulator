...
public class BcsAndBhsInstructionsTest extends InstructionTester {
    /**
     * Test of exitBcs and exitBhs methods, of class Processor.
     */
    @Test
    public void testExitBcsAndExitBhs() {
        cpsr.setCarry(true);
